...
module.exports = {
    ...
    async execute(oldChannel, newChannel) {
        ...
        if (oldChannel.name !== newChannel.name) return webhookDelivery(
            data,
            embed
                .setAuthor({
                    name: guild.name,
        ...
        if (oldChannel.topic !== newChannel.topic) return webhookDelivery(
            data,
            embed
                .setAuthor({
                    name: guild.name,
        ...
        if (oldChannel.position !== newChannel.position) return webhookDelivery(
            data,
            embed
                .setAuthor({
                    name: guild.name,
        ...
        if (oldChannel.type !== newChannel.type) return webhookDelivery(
            data,
            embed
                .setAuthor({
                    name: guild.name,
