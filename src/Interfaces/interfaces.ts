...
export interface TMDBMovie {
	...
	/** The movie's rating. */
	popularity: number;
	/** The movie's poster URL. */
	poster: string;
	/** The production companies that made the movie. */
	productionCompanies: string[];
	/** The streaming services the movie is available on. */
	streamingServices: string[];
	/** The movie's release date in Unix. */
...
export interface TMDBShow {
	...
	/** The show's rating. */
	popularity: number;
	/** The show's poster URL. */
	poster: string;
	/** The show's number of seasons. */
	seasons: string;
	/** The production companies that made the show. */
	productionCompanies: string[];
	/** The streaming services the show is available on. */
	streamingServices: string[];
	/** The time when the show's first episode aired. */
	firstAiredUnixed: number;
	/** The time when the show's last episode aired. */
	lastAiredUnixed: number;
	/** The show's status. */
	status: string;
	/** The show's tagline. */
	tagline: string;
