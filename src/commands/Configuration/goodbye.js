...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('goodbye')
		.setDescription('Manage and configure goodbye messages.')
		.setDefaultMemberPermissions(Administrator)
		.addSubcommand((options) =>
			options
				.setName('toggle')
				.setDescription(
					'Gives you the ability to toggle goodbye messages on and off.',
				)
		...
		.addSubcommand((options) =>
			options
				...
				.setDescription('Manage the embed sent when a user leaves the server.')
				.addStringOption((option) =>
					option
						.setName('color')
				...
				.addStringOption((option) =>
					option
						...
						.setDescription(
							'Provide a message that will be sent alongside the embed.',
						),
				),
		)
		.addSubcommand((options) =>
